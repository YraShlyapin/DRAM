    ...
    methods: {
        ...
        connect_db: function connect_db(id) {
            ...
            this.$http.get("/repertoireAPI/" + id).then(function (res) {
                ...
                this.$http.get("/galleryAPI/" + id).then(function (res) {
                    _this.gallery = res.body;
                    _this.show = true;
                    setTimeout(_this.ismini, 100);
                }).catch(function (res) {});
